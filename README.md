...
| 명령어 | 설명 |
| :---: | :---: |
| git init | 현재 폴더를 **Git으로 관리하기 시작**한다 |
| git clone | Github 저장소를 **내 컴퓨터로 복사해서 가져온다** |
| git add | 변경된 파일을 **커밋할 준비 상태로 등록**한다 |
| git commit | 변경 내용을 **하나의 작업 기록으로 저장**한다 |
| git push | 로컬 저장소의 변경 내용을 **Github 원격 저장소에 업로드**한다 |
| git pull | Github의 최신 변경 내용을 **내 컴퓨터로 가져온다** |
| git checkout | **다른 브랜치로 이동**한다 |
